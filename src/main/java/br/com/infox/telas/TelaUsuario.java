...
public class TelaUsuario extends javax.swing.JInternalFrame {
  Connection conexao = null;
    ...
    // MÉTODO CONSULTAR USUÁRIOS (SELECT) -  
    private void consultar () {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // a linnha abaixo refere ao combobox
                cboUsuPerfil.setSelectedItem(rs.getString(6));
                
    //código abaixo caso não encontre nenhum usuário com o nome cadastrado
            } else {
...
// MÉTODO ADICIONAR USUÁRIOS (INSERT)
...
private void limparCampos() {
    ...
    txtUsuLogin.setText("");
    txtUsuSenha.setText("");
    cboUsuPerfil.setSelectedIndex(0); // Reseta o combo box para o primeiro item
}
    ...
    private void initComponents() {
        ...
        btnUsuDelete.setToolTipText("Remover"); // NOI18N
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtUsuLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel5)
                                .addGap(18, 18, 18)
                                .addComponent(cboUsuPerfil, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtUsuSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtUsuId, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnUsuDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsuDeleteActionPerformed
        // chama o método deletar (excluir) 
        deletar();
